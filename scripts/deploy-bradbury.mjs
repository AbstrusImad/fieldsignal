...
const hash = await client.deployContract({ code, args: [true], leaderOnly: true });
...
const deployment = {
  ...
  migration: {
    ...
    sourceContract: source.contractAddress,
    sourceVerifiedAt: source.verifiedAt,
    acceptedSourceTransactions: source.acceptedActivityTransactions,
  },
};
